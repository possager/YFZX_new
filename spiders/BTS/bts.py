...
from bts_index import get_index
from bts_content import get_content
...
class bts(object):
    ...
    def save_result(self):
        def save_result(data):
            result_file = get_result_name(plantform_e='bts', plantform_c='第十师北屯市', date_time=data['publish_time'],
                                          urlOruid=data['url'],
                                          newsidOrtid=data['id'],
